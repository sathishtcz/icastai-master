...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.icastai@gmail.com';
    $mail->Password   = 'kisq zwwt hgrp abgq'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.icastai@gmail.com', 'ICASTAI Enquiry');
    $mail->addAddress('info.icastai@gmail.com', 'ICASTAI Enquiry');
    ...
    $replyMail->Username   = 'info.icastai@gmail.com';
    $replyMail->Password   = 'kisq zwwt hgrp abgq';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.icastai@gmail.com', 'ICASTAI Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICASTAI 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICASTAI 2025 Team</p>
        </div>
    ';
