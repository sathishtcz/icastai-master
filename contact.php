...
try {
    ...
    $mail->setFrom('info.icastai@gmail.com', 'Contact Submission System');
    $mail->addAddress('info.icastai@gmail.com', 'Contact Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICASTAI Contact Submission';
